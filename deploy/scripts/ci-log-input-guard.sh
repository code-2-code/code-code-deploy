...
guarded_names=(
  ...
  ACTIONS_RUNNER_NODE_VERSION
  ACTIONS_RUNNER_NODE_DOWNLOAD_BASE_URL
  ACTIONS_RUNNER_NODE_DOWNLOAD_FALLBACK_BASE_URL
  ACTIONS_RUNNER_PNPM_VERSION
  ACTIONS_RUNNER_BUF_VERSION
  ACTIONS_RUNNER_BUF_DOWNLOAD_BASE_URL
  ACTIONS_RUNNER_BUF_DOWNLOAD_FALLBACK_BASE_URL
  ACTIONS_RUNNER_PROTOC_GEN_GO_VERSION
  ACTIONS_RUNNER_PROTOC_GEN_GO_GRPC_VERSION
  ACTIONS_RUNNER_PROTOC_GEN_CONNECT_GO_VERSION
  ACTIONS_RUNNER_PROTOC_GEN_ES_VERSION
